    ...
    <div class="mt-6 p-6 bg-white dark:bg-gray-900 rounded-l text-muted border">
        ...
        <ul class="flex flex-col space-y-2">
            <li class="flex space-x-3 items-center">
                ...
                <a href="https://github.com/debugger-server/debugger" target="_blank" class="text-blue-600 dark:text-blue-200 underline">Github repository</a>
            </li>
            <li class="flex space-x-3 items-center">
                ...
                <span>Read the docs <a href="https://github.com/spatie/ray" target="_blank" class="text-blue-600 dark:text-blue-200 underline">spatie/ray</a></span>
            </li>
            <li class="flex space-x-3 items-center">

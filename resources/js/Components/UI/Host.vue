<template>
    <span class="inline-flex items-center justify-start space-x-2 py-1 text-muted">
        <span class="w-4 h-4">
            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 489.8 489.8"><circle cx="245" cy="453.9" r="26.8"/>

<template>
    <section class="py-5 px-4 md:px-6 lg:px-8 border-b">
        ...
        <div style="height: 400px;" class="flex flex-col border border-purple-300 dark:border-purple-700 rounded">
            <nav style="grid-template-columns: 1fr 100px 200px 17px" class="border-b border-purple-300 dark:border-purple-700 grid bg-purple-50 dark:bg-purple-800 text-xs font-bold text-purple-600 dark:text-purple-100 rounded-t">
                <div class="p-3 uppercase">description</div>
                <div class="p-3 uppercase">level</div>
                <div class="p-3 uppercase">time</div>
            </nav>
            <div class="bg-gray-100 dark:bg-gray-800 max-h-full flex-1 overflow-y-scroll divide-y divide-purple-300 dark:divide-purple-600">
